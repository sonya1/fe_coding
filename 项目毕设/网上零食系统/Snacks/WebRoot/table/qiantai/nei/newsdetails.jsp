...
<div class="content">
<h3 class="position">当前位置：首页>>公告详情</h3>
	<div class="gonggao">
		<div class="con">
		<div class="title">公告</div>
		 <table  cellspacing="20px" cellpadding="10px">
				<%
					...
					news = newsdao.selectOneInform(id);
					
				%>
					<tr>
						<td width="50px"><h3>标题</h3></td>
						<td width="100px"><h3>内容</h3></td>
						<td width="50px"><h3>时间</h3></td>
					</tr>
					<tr>
						<td><%=news.getTitle() %></td>
