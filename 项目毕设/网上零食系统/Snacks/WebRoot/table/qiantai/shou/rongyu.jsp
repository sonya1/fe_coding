	...
	<div class="header">
        <table border="1" cellpadding="10px" class="t1">
            <tr>
                ...
                <td><a href="<%=path %>/table/qiantai/shou/regist.html" class="se">注册</a></td>
    ...
    <div class="navi" id="nav">
        <div class="nav">
            <ul class="nav1">
                ...
                <li class="active1"><a href="<%=path %>/table/qiantai/shou/rongyu.jsp">荣誉资质</a></li>
...
<div class="content">
	<h3 class="position">当前位置：首页>>荣誉资质</h3>
	<div class="jieshao">
    	<div class="con">
